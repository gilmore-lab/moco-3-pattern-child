...
knitr::opts_chunk$set(fig.width=12, fig.height=8, fig.path=dir.figs)
```
...
```{r 1F1-select-chans-below-thresh}  
...
#### Figure 3 -- `r paste(this.harm, " Effects by Channel", sep="")`
...
#### Figure 4 -- `r paste( this.harm, " Channels Below p<.0005 for Pattern", sep="")`
...
#### Figure 5 -- `r paste(this.harm, " Selected Channels below p<.0005 for Pattern", sep="")`
...
## Mass univariate MANOVA on `r this.harm="1F2"`

MANOVA on `this.harm` with Pattern, Speed, and Pattern x Speed. Analyze and write write output to file.
...
#### Figure 6 -- `r paste(this.harm, " Effects by Channel", sep="")`
...
#### Figure 7 -- `r paste( this.harm, " Channels Below p<.0005 for Speed", sep="")`
...
#### Figure 8 -- `r paste(this.harm, " Selected Channels below p<.0005 for Speed", sep="")`
...
Small cluster in right mid-frontal channels for Pattern by Speed interaction, but ps <.001 and p<.01. 
