...
```{r figure-2F1-effects-by-channel}
pl.title <- paste(this.harm, "Effects by Channel", sep=" ")
...
```{r figure-3F1-effects-by-channel}
pl.title <- paste(this.harm, "Effects by Channel", sep=" ")
